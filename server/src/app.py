...
from server.src import db, login_manager
from server.src.namespaces.oauth2 import oauth2_namespace
from server.src.namespaces.support import support_namespace
from server.src.oauth2 import config_oauth
from server.src.settings.config import config_by_name
from server.src.settings.seed import seed
from server.src.views.api import api, restful_api
from server.src.views.auth import auth, resource_authorization
from server.src.views.admin import admin
from server.src.views.developer import developer
from server.src.views.user import user
